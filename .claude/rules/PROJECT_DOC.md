...
**Version:** 4.4 (release v0.1.0)
**Last updated:** 2026-03-29
**Owner:** Jerome Martin
**Stack:** Python 3.13, local (WS-002, Windows 11)
**Status:** First live run — 51 listings scraped (LBC + AutoScout24)
...
- **Git repo**: initialized 2026-03-28. Initial commit `d0b8999` (48 files, 10,231 lines). Not pushed to any remote. [UPDATED 2026-03-28]
- **Exact model IDs**: Haiku = `claude-haiku-4-5-20251001`, Sonnet = `claude-sonnet-4-20250514`. Defined in `llm_client.py` fallback chains and `config.py`. [UPDATED 2026-03-28]
